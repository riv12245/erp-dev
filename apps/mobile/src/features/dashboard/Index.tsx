...
const styles = StyleSheet.create({
  ...
  heading: { color: colors.text.primary, fontSize: 26, fontWeight: '700', marginTop: 3 },
  ...
  heroTitle: { color: '#fff', fontSize: 22, fontWeight: '700', maxWidth: 285, lineHeight: 28 },
  ...
  sectionTitle: { color: colors.text.primary, fontSize: 16, fontWeight: '700' }, sectionHint: { color: colors.text.muted, fontSize: 11 },
